...
const ProfileForm = ({ userProfile, loading, updateStatus }) => {
  const { fileData, success, toggleModal, onUpdate, handleImage } =
    useProfileForm();
  ...
  return (
    <div data-testid="test-form" className="rounded-lg">
      {success && (
      ...
      <div className="profile_upd_form ">
        <form
          ...
          onSubmit={(event) => handleSubmit(onUpdate)(event)}
        >
          <div className="flex flex-wrap  -mx-3 mb-6">
            <div className="sm:w-1/2 px-3">
              ...
              />
              {errors.country && (
                <span className="errorMsg text-red-600 text-sm">
