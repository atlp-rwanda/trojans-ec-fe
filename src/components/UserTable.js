    ...
    <div>
        {!loading && !error && (
                ...
                <div className='container mx-auto pagination my-4 flex outside' >
                    <button className='bg-gray-300 rounded px-2 py-[1px] hover:bg-gray-400 font-semibold' onClick={prevPage}>Prev</button>
                    <Pagination 
                    ...
                    />
                    <button className='bg-gray-300 rounded px-2 py-[1px] hover:bg-gray-400 font-semibold' onClick={nextPage}>Next</button>
                </div>
                </div>
                </div>
        )}
