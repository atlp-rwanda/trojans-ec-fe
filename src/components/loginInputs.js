  ...
  return (
    <div className="login-container">
     ...
     <div className="login-form-div">
      ...
      <div className="w-80">
      <input className="login-input bg-transparent outline-none w-full"
        placeholder="User Email"
        {...register("email")}
        name="email"
          type="text"
        />
        {errors.email && <p className="ml-3 text-red-500 text-sm">{errors.email.message}</p>}
      </div>
       <div className="w-80">
       <input className="login-input bg-transparent outline-none w-full"
       {...register("password")}
       name="password"
        ...
        type="password"
        />
        {errors.password && <p className="ml-3 text-red-500 text-sm">{errors.password.message}</p>}
       </div>
